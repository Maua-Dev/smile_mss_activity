...
from src.modules.create_activity.app.create_activity_viewmodel import UserViewmodel
...
class GetActivityWithEnrollmentsViewmodel:
    activity_dict: dict
    ...
    def to_dict(self):
        return {
            "activity_with_enrollments": ActivityViewmodel(activity=self.activity_dict['activity'],
                                                           enrollments=self.activity_dict['enrollments']).to_dict(),
