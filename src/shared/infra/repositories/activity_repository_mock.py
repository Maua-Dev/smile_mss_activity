...
class ActivityRepositoryMock(IActivityRepository):
    ...
    def __init__(self):
        ...
        self.enrollments = [
            Enrollment(activity_code=self.activities[0].code, user=self.users[0], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671229013000),
            Enrollment(activity_code=self.activities[0].code, user=self.users[1], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671315413000),
            Enrollment(activity_code=self.activities[0].code, user=self.users[2], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671401813000),
            Enrollment(activity_code=self.activities[0].code, user=self.users[3], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[0].code, user=self.users[4], state=ENROLLMENT_STATE.IN_QUEUE,
                       date_subscribed=1671574613000),
            Enrollment(activity_code=self.activities[0].code, user=self.users[5], state=ENROLLMENT_STATE.IN_QUEUE,
                       date_subscribed=1671574673000),
            Enrollment(activity_code=self.activities[0].code, user=self.users[6], state=ENROLLMENT_STATE.IN_QUEUE,
                       date_subscribed=1671574733000),
            Enrollment(activity_code=self.activities[1].code, user=self.users[1], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[2].code, user=self.users[3], state=ENROLLMENT_STATE.DROPPED,
                       date_subscribed=1671488212000),
            Enrollment(activity_code=self.activities[2].code, user=self.users[4], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[3].code, user=self.users[4], state=ENROLLMENT_STATE.REJECTED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[3].code, user=self.users[5], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671574613000),
            Enrollment(activity_code=self.activities[3].code, user=self.users[6], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671661013000),
            Enrollment(activity_code=self.activities[4].code, user=self.users[5], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671481013000),
            Enrollment(activity_code=self.activities[4].code, user=self.users[6], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[5].code, user=self.users[6], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[6].code, user=self.users[7], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[7].code, user=self.users[8], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671401813000),
            Enrollment(activity_code=self.activities[7].code, user=self.users[1], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[7].code, user=self.users[2], state=ENROLLMENT_STATE.DROPPED,
                       date_subscribed=1671574613000),
            Enrollment(activity_code=self.activities[8].code, user=self.users[9], state=ENROLLMENT_STATE.DROPPED,
                       date_subscribed=1671315413000),
            Enrollment(activity_code=self.activities[9].code, user=self.users[0], state=ENROLLMENT_STATE.DROPPED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[10].code, user=self.users[1], state=ENROLLMENT_STATE.DROPPED,
                       date_subscribed=1671488213000),
            Enrollment(activity_code=self.activities[11].code, user=self.users[1], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1670710613000),
            Enrollment(activity_code=self.activities[11].code, user=self.users[2], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1670710614000),
            Enrollment(activity_code=self.activities[11].code, user=self.users[3], state=ENROLLMENT_STATE.DROPPED,
                       date_subscribed=1670710615000),
            Enrollment(activity_code=self.activities[11].code, user=self.users[5], state=ENROLLMENT_STATE.ENROLLED,
                       date_subscribed=1670710616000),
            Enrollment(activity_code=self.activities[11].code, user=self.users[4], state=ENROLLMENT_STATE.IN_QUEUE,
                       date_subscribed=1671661013000),
            Enrollment(activity_code=self.activities[12].code, user=self.users[1], state=ENROLLMENT_STATE.COMPLETED,
                       date_subscribed=1668896213000),
            Enrollment(activity_code=self.activities[12].code, user=self.users[2], state=ENROLLMENT_STATE.COMPLETED,
                       date_subscribed=1668982612000),
            Enrollment(activity_code=self.activities[12].code, user=self.users[3], state=ENROLLMENT_STATE.COMPLETED,
                       date_subscribed=1669069013000),
            Enrollment(activity_code=self.activities[12].code, user=self.users[4], state=ENROLLMENT_STATE.ENROLLED,
