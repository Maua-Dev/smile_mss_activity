...
class Test_ManualDropActivityPresenter:
    ...
    def test_manual_drop_activity_presenter_missing_code(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
            ...
            "body": '{"user_id": "03555624-a110-11ed-a8fc-0242ac120002"}',
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        }
    ...
    def test_manual_drop_activity_presenter_missing_requester_user(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
    ...
    def test_manual_drop_activity_presenter_missing_user_id(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
    ...
    def test_manual_drop_activity_presenter_forbidden_not_professor(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
        ...
        assert json.loads(response["body"]) == "Apenas professores responsáveis da atividade e administradores podem desinscrever usuários"
    ...
    def test_manual_drop_activity_presenter_forbidden_not_professor(self):
        event = {
            ...
            "body": '{"code": "ECM2345", "user_id": "5a49ad2c-a110-11ed-a8fc-0242ac120002"}',
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        }
