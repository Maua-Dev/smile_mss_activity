...
from src.modules.enroll_activity_admin.app.enroll_activity_admin_presenter import lambda_handler
...
class Test_EnrollActivityAdminPresenter:
    ...
    def test_enroll_activity_admin_presenter(self):
        event = {
            ...
            "body": '{"code": "COD1468", "user_id": "0355573c-a110-11ed-a8fc-0242ac120002"}',
            "pathParameters": None,
    ...
    def test_ernoll_activity_admin_presenter_not_admin(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
        ...
        assert json.loads(response["body"]) == 'Usuário não é administrador'
