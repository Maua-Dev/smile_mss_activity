...
class Test_UpdateActivityPresenter:
    ...
    def test_update_activity_presenter(self):
        event = {
            ...
            "body": '{"code": "ECM2345", "new_title": "Clean Architecture code review!", "new_description": "Reviewing IMT student\'s codes", "new_activity_type": "LECTURES", "new_is_extensive": true, "new_delivery_model": "HYBRID", "new_start_date": 1669141012, "new_end_date": 1730465200000, "new_link": null, "new_place": "H331", "new_responsible_professors": ["62cafdd4-a110-11ed-a8fc-0242ac120002", "03555624-a110-11ed-a8fc-0242ac120002"], "new_speakers": [{"name": "Robert Cecil Martin", "bio": "Author of Clean Architecture: A Craftsman\'s Guide to Software Structure and Design", "company": "Clean Architecture Company"}], "new_total_slots": 100, "new_accepting_new_enrollments": false, "new_stop_accepting_new_enrollments_before": 1666451811}',
            "pathParameters": None,
