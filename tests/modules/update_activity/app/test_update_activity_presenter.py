...
class Test_UpdateActivityPresenter:
       ...
       def update_activity_presenter(self):
              event = {
                     "version": "2.0",
                     "routeKey": "$default",
                     "rawPath": "/my/path",
       ...
       def test_update_activity_presenter_400_code_mising(self):
              event = {
              "version": "2.0",
              "routeKey": "$default",
              "rawPath": "/my/path",
       ...
       def test_update_activity_presenter_400_code_invalid(self):
              event = {
              "version": "2.0",
              "routeKey": "$default",
              "rawPath": "/my/path",
       ...
       def test_update_activity_presenter_404_no_items_found_activity(self):
              event = {
              "version": "2.0",
              "routeKey": "$default",
              "rawPath": "/my/path",
