...
def compose_html(activity: Activity, user: UserInfo):
    ...
    message = """
        ...
        * {{
        ...
        <a href="https://d3ebnpochj0915.cloudfront.net/logo-footer-smile-2023.png" target="_blank"><img align="center" border="0" src="https://d3ebnpochj0915.cloudfront.net/logo-footer-smile-2023.png" alt="Logo Smile" title="Logo Smile" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 280px;" width="280"></a>
        </td>
        </tr>
        </table>
        </td>
